...
export const checkConfigurationHealth = () => {
  ...
  try {
    ...
    health.errors.push(`Environment check failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
  }
  ...
  try {
    ...
    health.errors.push(`Secret check failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
  }
  ...
  try {
    ...
    health.errors.push(`Build check failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
  }
  ...
  try {
    ...
    health.errors.push(`Validation check failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
  }
